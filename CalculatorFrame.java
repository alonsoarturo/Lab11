        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	try {
            		...
            		if (add.isSelected()) {
            			int sliderVal = Integer.parseInt(firstBox.getText());
            			int inputVal = Integer.parseInt(secondBox.getText());
            			int sum = (sliderVal + inputVal);
            			
            			String sumString = Integer.toString(sum);
            			
            			computeResult.setText(sumString);
            		}
            		
            		else if (multiply.isSelected()) {
            			int sliderVal = Integer.parseInt(firstBox.getText());
            			int inputVal = Integer.parseInt(secondBox.getText());
            			int product = (sliderVal * inputVal);
            			
            			String productString = Integer.toString(product);
            			
            			computeResult.setText(productString);
            		}
            		
            		else if (exponentiate.isSelected()) {
            			int sliderVal = Integer.parseInt(firstBox.getText());
            			int inputVal = Integer.parseInt(secondBox.getText());
            			int exp = (int) Math.pow(sliderVal, inputVal);
            			
            			String expString = Integer.toString(exp);
            			
            			computeResult.setText(expString);
            		}
            		
            		else if (modulus.isSelected()) {
            			int sliderVal = Integer.parseInt(firstBox.getText());
            			int inputVal = Integer.parseInt(secondBox.getText());
            			int mod = (sliderVal % inputVal);
            			
            			String modString = Integer.toString(mod);
            			
            			computeResult.setText(modString);
            		}
